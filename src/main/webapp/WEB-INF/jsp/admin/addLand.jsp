...
<div id="wrapper">
	...
	<div id="content">
	<form method="post" action="${pageContext.request.contextPath}/addLand"  enctype="multipart/form-data">	    
	<table>
		<tr>
		<td>土地昵称：</td>
		<td><input type="text" name="landName" required="required" placeholder="请输入土地昵称"/></td>
		</tr>
		<tr>
		<td>租赁价格：</td>
		<td><input type="text" name="landPrice" required="required" placeholder="请输入租赁价格"/></td>
		</tr>
		<tr>
		<td>上传图片：</td>
		...
		<tr>
		<td>土地描述：</td>
		<td><input type="text" name="landMs" required="required" placeholder="请输入土地描述" /></td>
		</tr>
		<tr>
		<td>土地位置：</td>
		...
		<td>
		<label for="landArea">
           	<input type="text" id="landArea" name="landArea" placeholder="请输入具体位置"/>
        </label>
		</td>
		</tr>
		<tr>
		<td>发布日期：</td>
		<td>
		 <input type="date" name="landRq" id="landRq" placeholder="请在这里输入放养日期">
		</td>
		</tr>
		<tr>
		<td>土地大小：</td>
		<td>
		<input type="text" name="landSize" placeholder="请输入土地大小" />
		</td>
		</tr>
	</table>
